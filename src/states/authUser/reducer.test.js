...
describe('authUserReducer function', () => {
  ...
  it('should return the authUser when given by SET_USER action', () => {
    // arrange
    const initialState = null;
    const action = {
  ...
  it('should return null when given by UNSET_USER action', () => {
    // arrange
    const initialState = {
      id: 1,
      name: 'User 1',
    ...
    const action = { type: ActionType.UNSET_USER };
